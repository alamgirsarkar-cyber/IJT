...
| 2a  | API contracts                                 | Same file → _API Contract_, `API01`…`API07` with payloads, success shapes and full exception tables                                                                                                                        | In Peer Review — Draft v1.1                  |
| 3   | Spec-derived test cases                       | Spec → _Unit Test Cases_ (`UT01`…`UT55`), expanded by QA in [`.ai-context/test_cases/internal-transfer-request.test_cases.md`](../.ai-context/test_cases/internal-transfer-request.test_cases.md)                          | Complete                                     |
...
| 9   | Gate 1 review                                 | [`.ai-context/reviews/internal-transfer-request.gate1.md`](../.ai-context/reviews/internal-transfer-request.gate1.md) (spec) and [`.gate1-plan.md`](../.ai-context/reviews/internal-transfer-request.gate1-plan.md) (plan) | **Pending** — templates for Abhijit Adhikari |
