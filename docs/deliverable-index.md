...
BRD-001  ──▶  spec v1.1 (draft)  ──▶  Gate 1 (spec)  ──▶  plan  ──▶  Gate 1 (plan)
                    │                      │ pending              │ pending
                    │                      ▼                      ▼
                    │               Abhijit Adhikari         Abhijit Adhikari
                    │
                    ▼
...
| 1a  | Business decision vs technical decision       | [`.ai-context/BRD.md`](../.ai-context/BRD.md) → _Business decisions vs technical decisions_                                                                                                                                | Complete                                     |
| 2   | Feature specification and acceptance criteria | [`.ai-context/specs/internal-transfer-request.spec.md`](../.ai-context/specs/internal-transfer-request.spec.md) — 21 individually identified AC (`internal-transfer-request.AC1`…`AC21`)                                   | In Peer Review — Draft v1.2                  |
| 2a  | API contracts                                 | Same file → _API Contract_, `API01`…`API07` with payloads, success shapes and full exception tables                                                                                                                        | In Peer Review — Draft v1.2                  |
| 3   | Spec-derived test cases                       | Spec → _Unit Test Cases_ (`UT01`…`UT59`), expanded by QA in [`.ai-context/test_cases/internal-transfer-request.test_cases.md`](../.ai-context/test_cases/internal-transfer-request.test_cases.md)                          | Complete                                     |
...
| 10  | Gate 2 evidence                               | Findings: [`.ai-context/reviews/internal-transfer-request.gate2.md`](../.ai-context/reviews/internal-transfer-request.gate2.md). Sign-off: append to [`.ai-context/state/completed.md`](../.ai-context/state/completed.md) (Tapas Dutta)                                                       | Prepared; **not yet evidenced**              |
...
| Artefact                                                              | Purpose                                                                                                 |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| [`.agent/rules/governance.md`](../.agent/rules/governance.md)         | Canonical Gate 1 / Gate 2 roles, DoR/DoD, reviewer write-back. Tripwires must not duplicate this. |
| [`.agent/rules/agent-role.md`](../.agent/rules/agent-role.md)         | Session operating procedure after the tripwire                                                    |
...
| [`.ai-context/architecture.md`](../.ai-context/architecture.md)       | Living system design, including Authentication and Authorisation (2026-09-08)                           |
| [`.ai-context/ownership_index.md`](../.ai-context/ownership_index.md) | Shared facts across specs (OWN-01 … OWN-07)                                                             |
| [`.ai-context/status.md`](../.ai-context/status.md)                   | Delivery board and daily execution log                                                                  |
| [`.ai-context/state/completed.md`](../.ai-context/state/completed.md) | Append-only Gate 2 verdict log                                                                          |
...
| [`.agent/workflows/`](../.agent/workflows/)                           | Spec review, plan, tests, code review, Gate Review Dashboard                                            |
...
- **Gate 1 not yet completed.** Review templates are ready for Abhijit Adhikari. Implementation is blocked until spec and plan are approved.
...
- **No test execution.** Every test case is specified; none has run. Every result in the QA
  file reads _Not Run_, and it says so rather than being left blank.
