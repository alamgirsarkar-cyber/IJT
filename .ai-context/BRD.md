...
|---|---|---|---|
| `internal-transfer-request` | Employee-facing request: draft, validate, submit, withdraw, and the employee's view of status and pending actions. Owns the request aggregate and its stage plan, and is the owner of the authoritative state and transition contract (OWN-10). | — | **In Peer Review (Gate 1)** — Draft v1.5 (2026-09-15 author revision of G1-F15–G1-F24); OQ-11 and OQ-22 closed by Product 2026-09-11 |
| `internal-transfer-approval-chain` | Line manager release, receiving manager acceptance, HR eligibility validation; decisions and terminal rejection. Transitions stages this spec creates. | `internal-transfer-request` | **In Peer Review (Gate 1)** — Draft v1.3; OQ-11 and OQ-12 closed by Product 2026-09-11; OWN-11 `If-Match` on API03 |
| `internal-transfer-downstream-orchestration` | Conditional fan-out to HRIS org update, Payroll, IT and Facilities; completion tracking and compensation on failure. | `internal-transfer-approval-chain` | **Approved** (v1.3, 2026-09-11); **v1.4 pending re-review** (OWN-11 CAS on API01, 2026-09-15). OQ-20 closed by Product 2026-09-11 (portal resume deferred) |
