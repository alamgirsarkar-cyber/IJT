...
|---|---|---|---|
| Payroll, ITSM and Facilities webhook consumers are not built | v1 emits events nobody consumes; those stages stay manual and are marked as such to the employee | Product; Architecture | `internal-transfer-downstream-orchestration` is specced |
