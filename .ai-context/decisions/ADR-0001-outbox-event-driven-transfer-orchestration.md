...
Publishing events from application code _after_ the database commit has a subtler failure: a
...
_how_ the event gets published and delivered without a message broker.
